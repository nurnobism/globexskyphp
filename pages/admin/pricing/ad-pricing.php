...
$db = getDB();
$rules = $db->query("SELECT * FROM pricing_rules WHERE category = 'advertising' ORDER BY sort_order ASC, created_at DESC")->fetchAll();

$pageTitle = 'Advertising Pricing';
include __DIR__ . '/../../../includes/header.php';
?>
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold"><i class="bi bi-megaphone-fill text-primary me-2"></i>Advertising Pricing</h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="/api/pricing.php?action=create_rule">
                <?= csrfField() ?>
                <input type="hidden" name="category" value="advertising">
