...
$db = getDB();
$rules = $db->query("SELECT * FROM pricing_rules WHERE category = 'inspection' ORDER BY sort_order ASC, created_at DESC")->fetchAll();

$pageTitle = 'Inspection Service Pricing';
include __DIR__ . '/../../../includes/header.php';
?>
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold"><i class="bi bi-clipboard-check text-warning me-2"></i>Inspection Service Pricing</h3>
