        ...
        <div class="row g-0 h-100">
            ...
            <div class="col-md-4 col-lg-3 sidebar-panel h-100">
                ...
                <div class="p-3 border-bottom bg-white">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <h6 class="fw-bold mb-0"><i class="bi bi-chat-dots me-2 text-primary"></i>Messages</h6>
            ...
            <div class="col-md-8 col-lg-9 chat-panel h-100" id="chatPanel">
                ...
                <div id="emptyState" class="d-flex flex-column align-items-center justify-content-center h-100 text-muted">
                    ...
                    <p class="small">Choose a chat from the sidebar or start a new one.</p>
                    <a href="<?= APP_URL ?>/pages/messages/compose.php" class="btn btn-primary mt-2">
                        <i class="bi bi-pencil-square me-1"></i>New Message
                    </a>
                </div>

                <!-- Active chat (hidden until room selected) -->
                <div id="activeChat" class="d-none d-flex flex-column h-100">
                    ...
                    <div class="p-3 border-bottom bg-white d-flex align-items-center gap-3">
                        <div class="avatar-circle" id="chatHeaderAvatar"
                        ...
                        <div class="flex-grow-1">
                            <div class="fw-semibold" id="chatHeaderName">—</div>
                    ...
                    <div class="chat-messages" id="chatMessages">
                        <div class="text-center text-muted small py-3" id="messagesLoading" style="display:none;">
